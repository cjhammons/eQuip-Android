package com.equip.equip.Util.location;
...
/**
 * borrowed from Jaison on github
 * https://github.com/jaisonfdo/LocationHelper/blob/master/app/src/main/java/com/droidmentor/locationhelper/LocationUtil/LocationHelper.java#L2
 */
...
public class LocationHelper implements PermissionUtils.PermissionResultCallback {
    ...
    {
        permissionUtils.check_permission(permissions,context.getString(R.string.need_gps_permission),1);
    }
